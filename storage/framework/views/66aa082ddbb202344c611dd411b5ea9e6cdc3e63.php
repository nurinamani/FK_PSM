...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Add new user form')); ?>
        ...
        <div class="row" style="padding: 25px">
            <div class="col-md-12" style="width: 100%">
                <div class="card" style="padding: 10px; width: 100%">
                    <div class="card-body">
                        <form action="<?php echo e(url('/')); ?>" method="post" style="padding: 25px; width: 100%">
                        <?php echo csrf_field(); ?>
            ...
            <div class="row" style="padding:25px;background-color:#e2e9e9" >
                <div class="mx-auto" style="width: 100%;">
                    <div class="card" style="background-color:#11ADA4;padding:10px;color:white;width:100%;" >
                        ...
                        <a href="<?php echo e(url('/TitleMainpageStu')); ?>" title="Back"><button class="btn btn-danger float-end"><i class="bi bi-arrow-left"></i> Back  
                        </button></a>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\FK_PSM\resources\views/userAdd.blade.php ENDPATH**/ ?>